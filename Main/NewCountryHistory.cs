    ...
    public partial class NewCountryHistory : Form
    {
        ...
        private void getParties()
        {
            foreach (XmlNode node in countries.ChildNodes[1].SelectNodes("party"))
            {
                ...
                comboBoxParties.Items.Add(Victoria2.Domain.Comm.FileHelper.Unescape(node.SelectSingleNode("name").InnerText).Replace("\"", ""));
            }
        }
        private void getGC()
        {
        ...
        private void buttonNextStep_Click(object sender, EventArgs e)
        {
            ...
            //14/16
            if (comboBoxParties.SelectedIndex == -1 || comboBoxGraphics.SelectedIndex == -1 || comboBoxCaptial.SelectedIndex == -1
            ...
            ruling_party.InnerText = Victoria2.Domain.Comm.FileHelper.Escape(comboBoxParties.SelectedItem.ToString());
